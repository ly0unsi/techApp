...
<div>
    ...
    <img :src="post.user.profilePic" alt="Image" class="author-pic img-fluid rounded-circle mx-auto">
    </div>
    <span class="d-block text-center">{{post.user.name}}</span>
    <span class="date d-block text-center small text-uppercase text-black-50 mb-5">{{moment(post.created_at).format("MMM DD,YYYY")}}</span>
    <h2 class="heading text-center">{{post.title}}</h2>
    <p class="lead mb-4 text-center">{{post.desc}}</p>
    <img :src="'/'+post.photo"  class="img-fluid rounded mb-4">
    <div style='text-align:justify' v-html="post.content">
    ...
    <h2 class="heading"><a >Your most unhappy customers are your greatest source of learning.</a></h2>
    ...
    <h2 class="heading">>Your most unhappy customers are your greatest source of learning</h2>
    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
    <a href="#" class="post-author d-flex align-items-center">
    <div class="author-pic">
    <img src="images/xperson_1.jpg.pagespeed.ic.ku-D0yMWz5.jpg" alt="Image">
